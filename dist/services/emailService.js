...
class EmailService {
    constructor() {
        ...
        this.fromEmail = process.env.SMTP_USER || "rminhal783@gmail.com";
        this.siteName = "Labwards";
    ...
    async initializeTransporter() {
        try {
            const settings = await SystemSettings_1.default.findOne().lean();
     ...
     */
    async sendPayoutRequestReceived(data) {
        const html = `
<!DOCTYPE html>
<html>
<head>
...
<body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #0A0C1A;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #0A0C1A; padding: 40px 20px;">
     ...
     */
    async sendPayoutSuccessful(data) {
        const html = `
<!DOCTYPE html>
<html>
<head>
