...
const FAQ = [
    {
        ...
        answer: 'Complete offers from offerwalls, play games, and participate in promotions. Your earnings are credited to your account balance where you can later withdraw.',
    },
    {
        id: 'faq-2',
        question: 'How do referrals work?',
        answer: 'Share your affiliate link with friends. When they sign up using your code and meet the referral conditions, you will receive referral earnings which you can claim from your referrals dashboard.',
    },
    {
        id: 'faq-3',
        question: 'What payout methods are available?',
        answer: 'We support multiple payout methods (PayPal, Crypto, WorldCoin). Visit the payouts endpoint to see available options for your account and region.',
    },
    {
        id: 'faq-4',
        question: 'I think I found a bug — how do I report it?',
        answer: 'Use the support contact form on the app or POST to /api/v1/support/contact with details. Include screenshots, timestamps, and steps to reproduce if possible.',
    },
];
...
---
Last updated: ${(0, dayjs_1.default)(lastUpdated).format()}
`;
